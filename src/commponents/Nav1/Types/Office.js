...
import './office.css'
import VAC_CLEAN3 from "../../../img/vac_clean3.png";
    ...
    return (
        <div>
            ...
            <div className="vac_clean3">
                <img src={VAC_CLEAN3} className="vac_clean003" alt="vac_clean3"/>
                <div className="description5">
                    ...
                    <div><a href="#" className="check_availability2"><button className="btn5">Check availability</button></a></div>
                </div>
            </div>
            <Bottom_column/>
        </div>
